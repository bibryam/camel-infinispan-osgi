...
fabric:profile-edit --features remote-client demo-profile 1.1    # requires JDG running
...
fabric:profile-edit --features remote-camel-producer demo-profile 1.1   # requires JDG running
