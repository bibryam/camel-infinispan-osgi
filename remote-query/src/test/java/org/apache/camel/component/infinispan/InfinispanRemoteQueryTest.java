...
import com.ofbizian.infinispan.Book;
import com.ofbizian.infinispan.BookMarshaller;
...
@Ignore(value = "Run with standalone infinispan server that has indexing enabled and book.protobin registered")
public class InfinispanRemoteQueryTest extends CamelTestSupport {
    ...
    public void findsCacheEntryBasedOnTheValue() throws Exception {
        ...
        final Book activemqBook = new Book("2", "ActiveMQ", "2222");
